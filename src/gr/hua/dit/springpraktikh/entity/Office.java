...
public class Office {
	...
	public Office(int id, String firstName, String lastName, String email, String username, String password,
			Integer enabled) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Office [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", email=" + email
